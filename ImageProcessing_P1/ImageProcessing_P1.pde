...
void setup() {
  ...
  background(255);
  Button b0 = new RectButton(color(0), color(225), width - 105, 0, 100, 25, new ICallable(){public void call(){cur = init;}}, "Reset");
  Button b1 = new RectButton(color(0), color(225), width - 105, 30, 100, 25, new ICallable(){ImageProcessor ip = new ImageProcessor();public void call(){cur = ip.lightnessGrayscale(cur);}}, "Lightness Grayscale");
  Button b2 = new RectButton(color(0), color(225), width - 105, 60, 100, 25, new ICallable(){ImageProcessor ip = new ImageProcessor();public void call(){cur = ip.averageGrayscale(cur);}}, "Average Grayscale");
  Button b3 = new RectButton(color(0), color(225), width - 105, 90, 100, 25, new ICallable(){ImageProcessor ip = new ImageProcessor();public void call(){cur = ip.luminosityGrayscale(cur);}}, "Luminosity Grayscale");
